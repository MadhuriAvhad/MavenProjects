...
public class LaunchLogin_Logout {
	...
	@BeforeMethod
	public void launchLogin() throws EncryptedDocumentException, IOException
	{
	...
	public void logout() throws InterruptedException, IOException
	{
		...
		File destination1 = new File("C:\\Users\\MADHURI AVHAD\\Pictures\\TestingScreenshots\\MKT"+Math.random()+".jpg");
